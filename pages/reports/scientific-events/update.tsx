...
import {IReportScientificEventsCreateParams, ScientificEventsReportModel} from "../../../core/models";
import {
...
const ScientificEventsReportUpdatePage = () => {
	...
	const onSubmit = async (fields: IReportScientificEventsCreateParams) => {
		const action = await dispatch(updateScientificEventsReportThunk({id: +reportId, body: fields}));
